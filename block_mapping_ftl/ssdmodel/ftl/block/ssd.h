...
typedef struct _ssd_power_list {
	double time;
	double energy;
	double element_active_energy;
	double total_active_energy;
	double power;
	struct _ssd_power_list *next;
	struct _ssd_power_list *prev;
} ssd_power_section;
...
typedef struct ssd {
	...
	double prev_time;
	double prev_energy;
	double prev_element_active_energy;
	double prev_total_active_energy;
	double section;
} ssd_t;
...
double  _ssd_write_page_osr(ssd_t *s, ssd_element_metadata *metadata, int lpn, ssd_power_element_stat *power_stat, int blkno);
