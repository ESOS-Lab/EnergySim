...
#ifdef DEBUG
	if((dfile=fopen("wait_request.txt","a"))==NULL){
		printf("Debug file open error in Active_elem function\n");
	}
#endif
...
#ifdef DEBUG
	fprintf(dfile,"%lf\t%d\t%d\n",simtime,elem_num, elem->metadata.reqs_waiting); 
#endif
